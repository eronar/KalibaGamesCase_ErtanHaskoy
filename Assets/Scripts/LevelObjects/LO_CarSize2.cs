...
public class LO_CarSize2 : MonoBehaviour, IColorChangeable , IRotatable, IDriveable , ILevelObjects
{
    ...
    void Update()
    {
        if (Input.GetKeyDown(KeyCode.B)) { LeanLeft(); }
    }
    ...
    /// <summary>
    /// Disables the door hitboxes, plays door opening/closing sequence and readies the car for departure
    /// </summary>
    /// <param name="is_left_door"></param>
